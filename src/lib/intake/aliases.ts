...
export const LANGUAGE_ALIASES: Record<Language, string[]> = {
  ...
  ar: ['арабск', 'arabic'],
  tr: ['турецк', 'turkish', 'türkçe'],
  uk: ['украинск', 'ukrainian'],
  hy: ['армянск', 'armenian'],
  ka: ['грузинск', 'georgian'],
  az: ['азербайджанск', 'azerbaijani'],
  kk: ['казахск', 'kazakh'],
  uz: ['узбекск', 'uzbek'],
  ...
  sq: ['албанск', 'albanian', 'shqip'],
  mk: ['македонск', 'macedonian'],
  bs: ['боснийск', 'bosnian', 'bosanski'],
  sw: ['суахили', 'swahili'],
}
...
export const CLIMATE_ALIASES: Record<ClimateZone, string[]> = {
  ...
  humid_subtropical: ['субтроп', 'subtropical'],
  tropical: ['тропич', 'tropical'],
  cold: ['холодн', 'субарктич', 'subarctic', 'nordic'],
}
