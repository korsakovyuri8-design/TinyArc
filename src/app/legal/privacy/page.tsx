    ...
    <section style={{ paddingTop: 'clamp(40px, 7vw, 72px)', paddingBottom: 80 }}>
      <div className="shell" style={{ maxWidth: 760 }}>
        ...
        <Article title="8. Your rights">
          ...
          <p>These are not statements of intent. A copy of your data, anonymising a profile and erasing the data of a closed project are single actions in the bureau panel, and the last two record the date on which they were carried out. A copy is assembled by the bureau and not handed out by the workspace itself: the workspace opens with a key from an email, and a button there would give your data to whoever that email reached. Your access key is not in the copy, a copy travels, and a key is credentials. Nothing belonging to anyone else is in it either. What stays after erasure is named in advance: invoices, because keeping them is an obligation of the country of registration, and task events, because the delivery metrics of other people are computed from them. A record that a given notice was sent also stays, without the address it went to: it is what stops the same notice being sent twice.</p>
